...
class MobileCalandrCardView extends GetView {
  const MobileCalandrCardView(this.calandarsData, this.subpage, {Key? key})
      : super(key: key);
              ...
              Expanded(
                child: Column(
                  children: [
                    ...
                    Text(
                      getNameOfMonth(DateTime.parse(calandarsData.dateStart!)),
                      style: GoogleFonts.roboto(
                          textStyle: TextStyle(
                              color: AppColorTheme.textColor.withOpacity(0.8),
                              fontSize: 18,
